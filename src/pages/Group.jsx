  ...
  const ButtonGroup = (
    ...
    >
      <Button
        ...
        startIcon={<DeleteIcon />}
        onClick={openConfirmDeleteHandler}
        sx={{ bgcolor: "#c62828", color: "white", ":hover": { bgcolor: "#b71c1c" } }}
      >
        Delete Group
      </Button>
      <Button
    ...
    >
      <Grid2
        sx={{
          display: { xs: "none", sm: "block" },
          width: "60vw",
          background: "linear-gradient(180deg, #fff0e8, #ffe6d9)",
          borderRight: "1px solid #d6bfb0",
        }}
        size={{ sm: 4 }}
      >
        <GroupList myGroups={myGroups?.data?.groups} chatId={chatId} />
      ...
      >
        ...
        {groupName && (
          <>
            {GroupName}
            <Typography margin="2rem" alignSelf="flex-start" variant="body1" color="#7a5c3e">
              Members
            </Typography>
            <Stack
              maxWidth="45rem"
              ...
              {isLoadingRemoveMember ? (
                ...
                members.map((i) => (
                  <UserItem
                    ...
                    isAdded
                    styling={{
                      boxShadow: "0 4px 12px rgba(101, 81, 58, 0.15)",
                      padding: "1rem 2rem",
                      borderRadius: "1rem",
                      bgcolor: "#fff8f0",
                      color: "#4e342e",
...
const GroupList = ({ w = "100%", myGroups = [], chatId }) => (
  ...
  >
    {myGroups.length > 0 ? (
      ...
      <Typography textAlign="center" padding="1rem" color="#a58f7e">
        No groups
      </Typography>
    )}
  </Stack>
  ...
  return (
    ...
    >
      <Stack
        ...
        sx={{
          padding: "1rem",
          ":hover": { bgcolor: "#f3e8dc" },
        }}
      >
        <AvatarCard avatar={avatar} />
        <Typography color="#5c4438" fontWeight="500">
          {name}
        </Typography>
      </Stack>
    </Link>
